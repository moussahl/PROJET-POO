...
/* 
  ...
  /insert type method 
	...
	public int insert_type(){
		...
		System.out.println("pour type maison type 1");
		System.out.println("pour type appartement type 2");
		System.out.println("pour type villa type 3");
		System.out.println("pour type terrin type 4");
...
//------------------------------------------------------
//insert taille 
public double insert_taille(Scanner scan){
	double input;
...
//------------------------------------------------------
  //insert localisation
  public String insert_localisation(){
		Scanner scan = new Scanner(System.in);
		System.out.println("tapez votre localisation");
...
public int set_service(){
	int input;
	Scanner scan = new Scanner(System.in);
  do{
		System.out.println("choisissez votre service");
		System.out.println("0 : Pour allocation");
...
public String set_description(){
  String input;
	Scanner scan = new Scanner(System.in);
	System.out.println("donner la description du cet immobilier");
  input = scan.nextLine();
	scan.close();
  return input;
}
